...
export const WITHDRAWAL_PROCEED_REQUEST = 'WTIHDRAWAL_PROCEED_REQUEST';
export const WITHDRAWAL_PROCEED_SUCCESS = 'WTIHDRAWAL_PROCEED_SUCCESS';
export const WITHDRAWAL_PROCEED_FAILURE = 'WTIHDRAWAL_PROCEED_FAILURE';
...
export const GET_PAYMENT_DETAILS_REQUEST = 'GET_PAYMENT_DEAILS_REQUEST';
export const GET_PAYMENT_DETAILS_SUCCESS = 'GET_PAYMENT_DEAILS_SUCCESS';
export const GET_PAYMENT_DETAILS_FAILURE = 'GET_PAYMENT_DEAILS_FAILURE';
